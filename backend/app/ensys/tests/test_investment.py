...
def test_regular_investement_initialization(sample_regular_investment):
    assert sample_regular_investment.ep_costs == 1239.3
    assert sample_regular_investment.maximum == 10000
    assert sample_regular_investment.minimum == 100
...
def test_nonconvex_investement_initialization(sample_nonconvex_investment):
    assert sample_nonconvex_investment.ep_costs == 1239.3
    assert sample_nonconvex_investment.maximum == 10000
    assert sample_nonconvex_investment.minimum == 100
    assert sample_nonconvex_investment.nonconvex == True
    assert sample_nonconvex_investment.offset == 42
